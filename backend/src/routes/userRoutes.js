...
router.get('/', authorize('admin', 'employee'), listUsersValidator, validate, listUsers);
router.post('/', authorize('admin'), createUserValidator, validate, createUser);
router.get('/:id', authorize('admin', 'employee'), userIdParamValidator, validate, getUserById);
