...
const AdminTransactions = () => {
  ...
  const clearFilters = () => { setFilters({ type: '', status: '', from: '', to: '' }); setSearch(''); setPage(1); };
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-gray-500 dark:text-gray-400 mt-0.5">Monitor all transactions across the system</p>
      </div>
      ...
      <div className="card p-5">
        <div className="flex flex-wrap gap-3 mb-5">
          <div className="relative flex-1 min-w-[200px]">
            ...
            <input className="input-field pl-10" placeholder="Search by account or description..."
        ...
        {loading ? <TableSkeleton rows={10} cols={7} /> : (
          <>
            ...
            <div className="flex items-center justify-between mt-4">
              <p className="text-xs text-gray-400">{meta.total ?? 0} total transactions</p>
